if (window.location.pathname == "/src/sports.html") {
  document.getElementById("sports").style.backgroundColor = "gray";
...
fetch(
  `https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=2158f02dc6b246c7b672beb6ae0da634&pageSize=10&page=1`,
  {
    method: "GET",
  }
)
...
window.addEventListener("scroll", () => {
  if (
    ...
    if (index < totalResults) {
      ...
      fetch(
        `https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=2158f02dc6b246c7b672beb6ae0da634&pageSize=10&page=${page}`,
        {
          method: "GET",
        }
      )

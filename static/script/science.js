if (window.location.pathname == "/src/science.html") {
  document.getElementById("science").style.backgroundColor = "gray";
  document.getElementById("science").style.color = "black";
  document.getElementById("science").style.fontWeight = "bold";
}
...
fetch(
  `https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=2158f02dc6b246c7b672beb6ae0da634&pageSize=10&page=1`,
  {
    method: "GET",
  }
)
...
window.addEventListener("scroll", () => {
  if (
    ...
    if (index < totalResults) {
      ...
      fetch(
        `https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=2158f02dc6b246c7b672beb6ae0da634&pageSize=10&page=${page}`,
        {
          method: "GET",
        }
      )
